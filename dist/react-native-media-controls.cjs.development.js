...
var MediaControls = function MediaControls(props) {
  var children = props.children,
      ...
      fadeOutDelay = _props$fadeOutDelay === void 0 ? 1000 : _props$fadeOutDelay,
  ...
  React.useEffect(function () {
    if (playerState === exports.PLAYER_STATES.ENDED) fadeInControls(false);
  }, [playerState]);
  ...
  var onPause = function onPause() {
    ...
    var PLAYING = exports.PLAYER_STATES.PLAYING,
        ...
        ENDED = exports.PLAYER_STATES.ENDED;
  ...
  }), !isFirstLoad || progress !== 0 ? React__default.createElement(Slider, {
    progress: progress,
    duration: duration,
    mainColor: mainColor,
